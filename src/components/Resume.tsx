  ...
  const experiences = [
    {
      ...
      description: 'Developed and maintained financial, e-commerce, and payment gateway platforms using NextJS. Ensured SEO optimization and improved loading speed with Next.js techniques. Collaborated with Product, SEO, Ad, and Marketing teams to deliver new features.',
    },
  ];
  ...
  const education = [
    {
      ...
      description: 'Foundation in computer science, mathematics, and software engineering.',
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold mb-8 text-white">Education & Experience</h3>
